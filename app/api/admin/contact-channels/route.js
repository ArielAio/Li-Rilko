...
export async function PUT(request) {
  ...
  try {
    const result = await saveContactChannelsInCatalog(payload?.contactChannels);
    ...
    return adminJson({ error: "Erro interno ao salvar canais." }, 500);
  }
}
